...
import { Github, Globe, MapPin, Play } from 'lucide-react'
...
export default function Portfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Developed during Hackacat Nano at Texas State University (7-hour hackathon), this project addresses food insecurity on campus through Bobcat Bounty, a student-run food pantry. The application features real-time inventory tracking, AI-powered recipe suggestions, and dietary information for food items.",
    ...
    },
    {
      ...
      description: "This AI application serves as an academic advisor for Texas State University students, allowing them to ask questions about McCoy College's undergraduate programs, course details, and receive recommendations tailored to their interests or needs.",
        ...
        <div className="flex flex-col-reverse md:flex-row justify-between items-start gap-8">
          <div className="space-y-6 flex-1">
            ...
            <div className="flex gap-2">
              ...
              <Link href="https://www.linkedin.com/in/saksham-adhikari-4727571b5/" target="_blank" className="rounded-md p-2 hover:bg-gray-100">
              ...
              <Link href="https://drive.google.com/file/d/1Fg7YZk_gBxakPRlKMskjW-Dv9c5S4ILg/view?usp=sharing" target="_blank" className="rounded-md p-2 hover:bg-gray-100">
              ...
              <CardContent className="space-y-4">
                <div className="flex flex-col gap-4 max-w-3xl mx-auto">
                  {project.video ? (
                    ...
                    // Image-only container with proper sizing and click handler
                    <div 
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <ul className="mt-2 space-y-2">
                <li>• Analyzed predictive rates of industry demand for college graduates, identifying sectors and companies with the highest need for new hires</li>
                <li>• Developed Regression models to forecast employment trends and opportunities in various industries</li>
                <li>• Collaborated with the team to create targeted marketing campaigns based on insights to create targeted training programs for conversion</li>
              </ul>
            </CardContent>
          </Card>
        </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex flex-wrap gap-2">
                {['Python', 'R', 'MySQL', 'HTML', 'CSS', 'JavaScript', 'Docker', 'Pine script', 'MATLAB'].map((skill) => (
